...
export const translations = {
  es: {
    ...
    organizerTitle: "Información del evento",
  ...
  en: {
    ...
    organizerTitle: "Event information",
  ...
  nl: {
    ...
    total: "Totaal",
    continueReservation: "Doorgaan met reserveren",
    processing: "Bezig...",
    ...
    organizerTitle: "Evenementinformatie",
